...
def test_probe_param_construction_valid(
    ...
    (which were not explicitly set) are set to 55 (`valid_probe_params.probe_tms.min` - 10)."""
    ...
    assert valid_probe_params.probe_max_self_end_thermo == 55.0
    assert valid_probe_params.probe_max_hairpin_thermo == 55.0
